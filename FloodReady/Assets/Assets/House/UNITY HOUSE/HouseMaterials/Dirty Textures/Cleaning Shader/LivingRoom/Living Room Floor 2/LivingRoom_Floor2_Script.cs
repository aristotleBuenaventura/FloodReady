...
public class LivingRoom_Floor2_Script : MonoBehaviour
{
    ...
    private void CleanWall()
    {
        ...
        {
            if (hit.collider.CompareTag("LivingRoom_Floor2"))
            {
                ...
                if (dirtMaskTexture != null)
                {
                    ...
                    Floor.floor2(cleanAmount * .4);
                    MaterialManager.UpdateMaterialValue("Floor 2");
                }
            }
        }
    }
