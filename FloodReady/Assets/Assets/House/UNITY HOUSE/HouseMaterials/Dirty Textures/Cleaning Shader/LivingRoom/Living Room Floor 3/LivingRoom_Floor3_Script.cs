...
public class LivingRoom_Floor3_Script : MonoBehaviour
{
    ...
    public Living_Flooring123 Floor;
    ...
    private void CleanWall()
    {
        ...
        {
            if (hit.collider.CompareTag("LivingRoom_Floor3"))
            {
                ...
                if (dirtMaskTexture != null)
                {
                    ...
                    Floor.floor3(cleanAmount * .4);
                    MaterialManager.UpdateMaterialValue("Floor 3");
                }
            }
        }
    }
