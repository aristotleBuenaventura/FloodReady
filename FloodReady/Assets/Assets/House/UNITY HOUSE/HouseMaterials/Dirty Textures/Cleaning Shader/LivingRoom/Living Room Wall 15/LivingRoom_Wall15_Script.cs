...
public class LivingRoom_Wall15_Script : MonoBehaviour
{
    ...
    public Living_Room111213151617 Wall;
    ...
    private void CleanWall()
    {
        ...
        {
            if (hit.collider.CompareTag("LivingRoom_Wall15"))
            {
