...
public class LivingRoom_Wall14_1_Script : MonoBehaviour
{
    ...
    private void CleanWall()
    {
        ...
        {
            if (hit.collider.CompareTag("LivingRoom_Wall14-1"))
            {
