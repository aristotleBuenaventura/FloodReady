...
public class Kitchen_Wall8_Script : MonoBehaviour
{
    ...
    private void Update()
    {
        if (OVRInput.Get(OVRInput.Button.SecondaryIndexTrigger))
        {
            ...
            {
                if (hit.collider.CompareTag("Kitchen_Wall8")) // Check if the object hit has the tag "Plug"
                {
                    ...
                    MaterialManager.UpdateMaterialValue("Wall 8");
                }
            }
        }
    }
