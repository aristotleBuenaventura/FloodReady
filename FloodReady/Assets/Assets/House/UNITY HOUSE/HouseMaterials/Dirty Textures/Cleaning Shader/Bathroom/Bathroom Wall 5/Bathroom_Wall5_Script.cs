...
public class Bathroom_Wall5_Script : MonoBehaviour
{
    ...
    private void Update()
    {
        if (OVRInput.Get(OVRInput.Button.SecondaryIndexTrigger))
        {
            ...
            {
                if (hit.collider.CompareTag("Bathroom_Wall5")) // Check if the object hit has the tag "Plug"
                {
                    ...
                    if (dirtMaskTexture != null)
                    {
                        ...
                        MaterialManager.UpdateMaterialValue("Wall 5");
                    }
                }
            }
        }
