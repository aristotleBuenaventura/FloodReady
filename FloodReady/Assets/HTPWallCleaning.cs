...
public class HTPWallCleaning : MonoBehaviour
{
    [SerializeField] private WaterControllerHTP waterController; // Reference to the WaterController script
    ...
    private void CleanWall()
    {
        ...
        {
            if (hit.collider.CompareTag("LivingRoom_Wall11"))
            {
