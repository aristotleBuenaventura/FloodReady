...
public class CloseHintScene2 : MonoBehaviour
{
    ...
    public ShowHintCanvasScene2 ShowHintCanvasScene2;
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.CompareTag("Hand"))
        {
            ...
            ShowHintCanvasScene2.HideAllCanvas();
    ...
    private void Update()
    {
        ...
        if (objectToMonitor1.activeSelf || objectToMonitor2.activeSelf || objectToMonitor3.activeSelf || objectToMonitor4.activeSelf ||
            objectToMonitor5.activeSelf || objectToMonitor6.activeSelf ||  objectToMonitor9.activeSelf)
        {
