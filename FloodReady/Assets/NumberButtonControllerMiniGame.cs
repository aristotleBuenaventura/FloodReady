...
public class NumberButtonControllerMiniGame : MonoBehaviour
{
    public string number; // Set this in the Inspector for each button
    public NumberArrayManagerMiniGame arrayManager;
    ...
    private void Start()
    {
        ...
        arrayManager = FindObjectOfType<NumberArrayManagerMiniGame>();
    }
